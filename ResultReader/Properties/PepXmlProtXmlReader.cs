...
namespace ResultReader
{
    public class PepXmlProtXmlReader 
    {
        ...
        private void PepXML_getProtPepPsmInfo(XmlReader queryXmlReader)
        {
            ...
            this.Read_PsmInfo(queryXmlReader, shared_psmObj);
        ...
        private void Read_peptideInfo(XmlReader pepReader, ds_Peptide pepObj, ds_PSM psmObj, ds_Protein protObj)
        {
            ...
            pepObj.Pep_calc_mr = (pepReader.GetAttribute("calc_neutral_pep_mass") != null) ? double.Parse(pepReader.GetAttribute("calc_neutral_pep_mass")) : 0.0;
        ...
        private void Read_PsmInfo(XmlReader psmReader, ds_PSM psmObj)
        {
            ...
            psmObj.Pep_exp_mr = (psmReader.GetAttribute("precursor_neutral_mass") != null) ? double.Parse(psmReader.GetAttribute("precursor_neutral_mass")) - Math.Abs(psmObj.Charge) : 0.0;
            psmObj.Pep_exp_mz = (double)(psmObj.Pep_exp_mr / psmObj.Charge);
        ...
        {
            psmObj.MassError = pepObj.Pep_calc_mr - psmObj.Pep_exp_mr;
        }
