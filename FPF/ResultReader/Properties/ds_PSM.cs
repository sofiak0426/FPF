...
namespace ResultReader
{
    ...
    public class ds_PSM
    {
        ...
        private double _pep_exp_mz = 0; //Experimental m/z
        private double _pep_exp_mr = 0; //Experimental Mr
        ...
        public double Pep_exp_mz
        {
            get { return _pep_exp_mz; }
            set { _pep_exp_mz = value; }
        }

        public double Pep_exp_mr
        {
            get { return _pep_exp_mr; }
            set { _pep_exp_mr = value; }
        }
