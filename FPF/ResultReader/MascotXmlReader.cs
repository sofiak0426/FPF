            ...
            while (PepInfoReader.Read()) //search every Nodes in "peptide"
            {
                ...
                switch (PepInfoReader.Name)
                {
                    ...
                    case "pep_calc_mr": //Calculated Mr; calculated relative molecular mass.
                        pepObj.Theoretical_mass = (PepInfoReader.IsEmptyElement != true) ? PepInfoReader.ReadElementContentAsDouble() : 0.0;
                        break;
                    ...
                    case "pep_exp_mz": //Experimental m/z
                        psmObj.Precursor_mz = (PepInfoReader.IsEmptyElement != true) ? PepInfoReader.ReadElementContentAsDouble() : 0.0;
                        break;

                    case "pep_exp_mr"://Experimental Mr
                        psmObj.Pep_exp_mass = (PepInfoReader.IsEmptyElement != true) ? PepInfoReader.ReadElementContentAsDouble() : 0.0;
                        break;
